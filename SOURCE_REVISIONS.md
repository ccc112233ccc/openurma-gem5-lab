...
| --- | --- | --- | --- |
| OpenURMA integration and scaffold | `../OpenURMA` | `0ae5dce300154d761f97095864bda0cf2546b265` | `1f58c45` (data-path implementation snapshot; runtime validation pending) |
