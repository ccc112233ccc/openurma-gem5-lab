...
| --- | --- | --- | --- |
| OpenURMA integration and scaffold | `../OpenURMA` | `0ae5dce300154d761f97095864bda0cf2546b265` | `5372409` (official one-guest loopback data path validated) |
...
`stage/2026-09-17-official-loopback-perftest`. The OpenURMA commit shown above
