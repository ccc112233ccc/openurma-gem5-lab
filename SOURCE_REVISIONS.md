...
| --- | --- | --- | --- |
| OpenURMA integration and scaffold | `sources/OpenURMA` | `0ae5dce300154d761f97095864bda0cf2546b265` | `8260ffe97c5ec1bc23a948a3d32e6cbaadd25177` |
...
bonding SEND/READ/WRITE runs, plus the three-process C++ event-driven
Adapter-local SEND path, on 2026-09-21. Reviewable patch series and exact
